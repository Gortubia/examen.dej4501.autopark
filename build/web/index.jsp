                                                            ...
                                                            <c:forEach  items="${sessionScope.voucherVD.listadoTickets}" var="ticketVD">
                                                                <tr>
                                                                    ...
                                                                    <td><c:out value="${ticketVD.idTicket}"></c:out> </td> 
                                                                        <!-- Elimina ticket de la tabla llama al get del servlet ::: /procesaTicketsServlet-->
                                                                    <c:url value="./procesaTicketsServlet" var="eliminar">
                                                                        <c:param name="codigo" value="${ticketVD.idTicket}"></c:param>
                                                                    </c:url>
                                                                    <td><input type="button" class=" btn-warning btn-small" name="btnEliminar" value="-" onclick="window.location.href = '${eliminar}'"> </td>
